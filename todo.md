...
## Feature: Sistema de Alertas de Integridad de Planes
- [x] Crear procedimiento backend para validar integridad de planes
- [x] Detectar colaboradores faltantes en nómina
- [x] Detectar cambios de cargo/departamento
- [x] Implementar interfaz de alertas en módulo Planes
